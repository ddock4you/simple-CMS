...
export function AuditLogPagination({ page, pageSize, total }: AuditLogPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="outline" size="sm" onClick={() => navigate(page + 1)} disabled={page >= totalPages}>
          다음
