...
const TIPTAP_CONTENT_CLASSES = [
  ...
  'prose-h2:mt-[40px]! prose-h2:mb-[16px]! prose-h2:text-[24px]! prose-h2:leading-[1.35]! prose-h2:font-bold',
  'prose-h3:mt-[32px]! prose-h3:mb-[12px]! prose-h3:text-[20px]! prose-h3:leading-[1.4]! prose-h3:font-semibold',
  'prose-p:my-[16px]! [&_p:first-child]:mt-0! [&_h1:first-child]:mt-0! [&_h2:first-child]:mt-0! [&_h3:first-child]:mt-0!',
  'prose-a:text-[#0056d6]! prose-a:underline prose-a:underline-offset-[2px] prose-a:hover:decoration-2',
  'prose-ul:my-[16px]! prose-ul:pl-[24px]! prose-ul:list-disc! prose-ol:my-[16px]! prose-ol:pl-[24px]! prose-ol:list-decimal! prose-li:my-[4px]!',
  '[&_li>ul]:my-[4px]! [&_li>ol]:my-[4px]! [&_ul_ul]:list-[circle]! [&_ul_ul_ul]:list-[square]!',
  'prose-blockquote:my-[24px]! prose-blockquote:border-l-[4px]! prose-blockquote:border-[#0056d6]! prose-blockquote:bg-[#f8f9fa] prose-blockquote:px-[16px]! prose-blockquote:py-[8px]! prose-blockquote:text-[#555]! prose-blockquote:not-italic',
  ...
  'prose-pre:my-[24px]! prose-pre:overflow-x-auto prose-pre:rounded-[8px] prose-pre:bg-[#1e1e1e]! prose-pre:p-[16px]! prose-pre:text-[#d4d4d4]! [&_pre_code]:rounded-none [&_pre_code]:bg-transparent! [&_pre_code]:p-0! [&_pre_code]:text-[14px]! [&_pre_code]:text-inherit!',
  ...
  'prose-table:my-[24px]! prose-table:block! prose-table:w-full prose-table:overflow-x-auto prose-table:border-collapse [&_th]:border [&_th]:border-[#dee2e6] [&_th]:bg-[#f8f9fa] [&_th]:px-[12px] [&_th]:py-[8px] [&_th]:text-left [&_th]:align-top [&_th]:font-semibold [&_td]:border [&_td]:border-[#dee2e6] [&_td]:px-[12px] [&_td]:py-[8px] [&_td]:text-left [&_td]:align-top',
